...
test("FND-03 closes the observed RU publication defects and their bounded malformed-template siblings", () => {
  ...
  for (const correction of [
    ...
    "Нужно перейти от конкретного комбо к семейству и его свойствам, затем учесть контекст.",
    "Перенос проверяется на неидентичных примерах.",
    "Не стоит ограничиваться распознаванием: нужен переносимый переход к семейству руки.",
