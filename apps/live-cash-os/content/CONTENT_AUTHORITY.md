...
STATE-INTEGRITY-RESIDUALS-2026-09-17 records the persistence-only Quick Start relock at canonical review-corpus fingerprint `ab1dca9aafb5926a491e639f2ee444c1e8ec9d818bb38792cc65db055a6d0798`. The governed component change only integrates bounded attempt counting and explicit confidence provenance; learner-facing copy, decision/option IDs, scoring, mastery thresholds, source ceilings and all human approval states remain unchanged. Deterministic validation remains rejection-only and creates no approval.
