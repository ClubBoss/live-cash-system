...
The generated Practical Mastery decision corpus has a separate final presentation-only RU composition step, `applyPracticalRuCopyRepair`, after its source-governed decision sets are assembled. It only replaces learner-facing Russian strings and is source-locked together with `content/practical-mastery/index.ts`; it may not change decision IDs, option IDs, correct-answer IDs, misconceptions, source references, scoring, mastery, scheduler, retention, transfer, field evidence or English copy. Its machine checks are rejection evidence only and do not create human RU approval.
...
`e7f7381cf73ff1a33b5d1249d3efeca524225f68d5b213605193dff30243b048`
...
- exact final RU composition at digest `e7f7381cf73ff1a33b5d1249d3efeca524225f68d5b213605193dff30243b048`;
...
- the generated Practical Mastery RU decision surface affected by `applyPracticalRuCopyRepair`.
