...
const ESSENTIAL_TERMS: Partial<Record<ModuleId, Record<LocaleCode, NoviceTerm[]>>> = {
  ...
  preflop: {
    ru: [
      ...
      {
        term: "Свойства руки",
        meaning: "Готовая пара, масть, связность, high-card сила, чувствительность к доминации и блокеры помогают понять руку. Какие свойства важны, решает конкретный контекст; семейство не выбирает действие само.",
      },
    ],
    en: [
      {
