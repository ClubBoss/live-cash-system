...
const families:Family[]=[
  {
    ...
    whyRu:"Reviewed PokerCoaching outs material defines dirty outs as apparent improvements that do not reliably produce the best hand and warns that counting them fully inflates equity.",whyEn:"Dirty outs are apparent improvements that do not reliably make the best hand; counting them fully overstates equity.",
  ...
  },
  {
    ...
    whyRu:"A sound SB limping range contains traps and strong hands, so it needs a response branch after a BB isolation raise.",whyEn:"A sound SB limping range contains traps and strong hands, so it needs a response branch after a BB isolation raise.",
  ...
  },
  {
    ...
    whyRu:"Dirty-outs and combo-draw overlap change draw robustness; raising urgency also depends on fold equity and how cleanly the draw improves.",whyEn:"Dirty-outs and combo-draw overlap change draw robustness; raising urgency also depends on fold equity and how cleanly the draw improves.",
  ...
  },
  {
    ...
    whyRu:"At 300bb, OOP blinds can 3-bet less because depth magnifies realization problems; at 300bb, implied-odds upside is also paired with larger reverse-implied losses.",whyEn:"At 300bb, OOP blinds can 3-bet less because depth magnifies realization problems; at 300bb, implied-odds upside is also paired with larger reverse-implied losses.",
  ...
  },
  {
    ...
    whyRu:"Multiway continuing ranges are generally stronger and bluff supply smaller; river value and bluff-catches still require concrete worse calls or credible bluffs.",whyEn:"Multiway continuing ranges are generally stronger and bluff supply smaller; river value and bluff-catches still require concrete worse calls or credible bluffs.",
