...
export const practicalSkillFamilies: PracticalSkillFamily[] = [
  ...
  f("BL-05", "W3_BLINDS", "SB: исключения к 3-bet-or-fold", "SB: exceptions to the 3-bet-or-fold default", "После базового PF-05 распознавать, когда BB behind, opener continue range и hand class возвращают conditional flat или превращают forced 3-bet в fold.", ["blinds"], ["PF-05"], ["FTGU-E06"], "P0", "CHANGED_NODE_TRANSFER"),
  ...
  f("MW-04", "W11_MULTIWAY_LIMP", "Limped multiway transfer", "Limped multiway transfer", "Переносить уже изученный PF-02 в несколько limpers: сравнивать iso и overlimp через реальный fold equity, вероятность multiway и цену входа.", ["preflop", "multiway"], ["PF-02"], ["FTGU-E03"], "P0", "CHANGED_NODE_TRANSFER"),
