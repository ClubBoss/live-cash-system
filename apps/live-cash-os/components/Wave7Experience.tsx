...
function copy(locale: LocaleCode) {
  return locale === "ru" ? {
    ...
    captureBody: "Сначала быстро зафиксируй 1–3 решения до результата. Затем выбери одну руку и сделай самопроверку. Только если отдельный разбор с человеком установил конкретный механизм, это можно определить как точный навык Practical. Одна раздача — наблюдение, а не доказательство частоты или общего типа игрока.",
